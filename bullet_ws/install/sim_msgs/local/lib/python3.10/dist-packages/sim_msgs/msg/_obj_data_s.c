...
bool sim_msgs__msg__obj_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sim_msgs.msg._obj_data.ObjData", full_classname_dest, 30) == 0);
  }
  sim_msgs__msg__ObjData * ros_message = _ros_message;
  {  // obj_id
  ...
  {  // current
    ...
    ros_message->current = (Py_True == field);
    Py_DECREF(field);
  }
  {  // x
...
{
  /* NOTE(esteve): Call constructor of ObjData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sim_msgs.msg._obj_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjData");
  ...
  {  // current
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->current ? 1 : 0);
    {
